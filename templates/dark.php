<?php
/**
 * Dark error page template.
 *
 * Always-dark background with light text, modern SaaS feel,
 * clean typography and subtle gradients. Self-contained.
 *
...
<body class="gcep-error-page gcep-template-dark" data-dark-mode="disabled">
