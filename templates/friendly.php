...
<body class="gep-error-page gep-template-friendly" data-dark-mode="<?php echo esc_attr( (string) ( $context['dark_mode'] ?? 'auto' ) ); ?>">
	<main class="gep-card">
		...
		<?php else : ?>
			<svg class="gep-illustration" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
				<circle cx="36" cy="36" r="36" fill="var(--gep-brand-color)" opacity="0.08"/>
				<circle cx="36" cy="36" r="24" fill="var(--gep-brand-color)" opacity="0.1"/>
				<path d="M36 22v16" stroke="var(--gep-brand-color)" stroke-width="3" stroke-linecap="round"/>
				<circle cx="36" cy="46" r="2" fill="var(--gep-brand-color)"/>
			</svg>
		<?php endif; ?>
