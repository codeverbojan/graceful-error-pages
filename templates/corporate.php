...
<body class="gep-error-page gep-template-corporate" data-dark-mode="<?php echo esc_attr( (string) ( $context['dark_mode'] ?? 'auto' ) ); ?>">
	<main class="gep-card">
		...
		<?php elseif ( ! empty( $context['site_name'] ) ) : ?>
			<div class="gep-logo-text"><?php echo esc_html( (string) $context['site_name'] ); ?></div>
		<?php endif; ?>
