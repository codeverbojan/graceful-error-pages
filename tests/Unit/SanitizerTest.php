...
class SanitizerTest extends TestCase {
	...
	/**
	 * Test URL sanitizer accepts valid URLs.
	 *
	 * @return void
	 */
	public function test_url_accepts_valid(): void {
		...
		$this->assertSame( 'https://example.com/logo.png', Sanitizer::url( 'https://example.com/logo.png' ) );
	}

	/**
	 * Test URL sanitizer handles non-string input.
	 *
	 * @return void
	 */
	public function test_url_handles_non_string(): void {
		$this->assertSame( '', Sanitizer::url( null ) );
		$this->assertSame( '', Sanitizer::url( 42 ) );
		$this->assertSame( '', Sanitizer::url( [] ) );
	}

	/**
	 * Test text sanitizer accepts strings.
	 *
	 * @return void
	 */
	public function test_text_accepts_string(): void {
		Functions\when( 'sanitize_text_field' )->returnArg();
	...
	/**
	 * Test text sanitizer handles non-string input.
	 *
	 * @return void
	 */
	public function test_text_handles_non_string(): void {
		$this->assertSame( '', Sanitizer::text( null ) );
		$this->assertSame( '', Sanitizer::text( 42 ) );
		$this->assertSame( '', Sanitizer::text( [] ) );
	}

	/**
	 * Test kses sanitizer accepts strings.
	 *
	 * @return void
	 */
	public function test_kses_accepts_string(): void {
		Functions\when( 'wp_kses_post' )->returnArg();

		$this->assertSame( '<strong>Bold</strong> text', Sanitizer::kses( '<strong>Bold</strong> text' ) );
	}

	/**
	 * Test kses sanitizer handles non-string input.
	 *
	 * @return void
	 */
	public function test_kses_handles_non_string(): void {
		$this->assertSame( '', Sanitizer::kses( null ) );
		$this->assertSame( '', Sanitizer::kses( 42 ) );
		$this->assertSame( '', Sanitizer::kses( [] ) );
	}
